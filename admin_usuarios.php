        ...
        <div class="modal-content">
            ...
            <form id="user-form" action="" method="post" class="p-6 space-y-5">
                ...
                <div class="flex justify-end items-center space-x-4">
                    ...
                    <button type="submit" class="bg-primary text-white font-bold py-2 px-5 rounded-lg hover:bg-[#28d15e] transition">Salvar Usuário</button>
                </div>
            </form>
        </div>
    </div>
                ...
                try {
                    ...
                    if (data.users.length === 0) {
                        ...
                        data.users.forEach(user => {
                            ...
                            if (user.tipo === 'admin') {
                                userTypeClass = 'bg-purple-900/30 text-purple-300'; // Admin
                                userTypeText = 'Admin';
                            } else if (user.tipo === 'infoprodutor') {
                                userTypeClass = 'bg-green-900/30 text-green-300'; // Infoprodutor
                            ...
                            tr.innerHTML = `
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ${user.telefone 
                                        ? `<div class="text-sm text-gray-400">${user.telefone}</div>`
                                        : `<span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-700/50 text-gray-400">Não informado</span>`
                                    }
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
