...
<div class="flex h-screen bg-dark-base font-sans">
    <div class="w-1/3 h-full bg-dark-card shadow-lg overflow-y-auto border-r border-[#32e768]">
        <form action="/index?pagina=checkout_editor&id=<?php echo $id_produto; ?>" method="post" enctype="multipart/form-data" class="p-6">
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <div class="space-y-4 p-4 border border-dark-border rounded-lg bg-dark-elevated">
                        ...
                        <div>
                            ...
                            <input type="file" name="add_banner_files[]" multiple accept="image/*" class="w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#32e768] file:text-white hover:file:bg-[#28d15e]"/>
                        </div>
                        ...
                        <!-- INÍCIO: BANNERS MÚLTIPLOS (LATERAL) -->
                         <div>
                            ...
                            <input type="file" name="add_side_banner_files[]" multiple accept="image/*" class="w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#32e768] file:text-white hover:file:bg-[#28d15e]"/>
                        </div>
                ...
                <div>
                    <input type="hidden" name="order_bumps_section" value="1">
                    <h2 class="text-xl font-semibold mb-4 text-white flex items-center gap-2">
                    ...
                    <div class="p-4 border border-dark-border rounded-lg bg-dark-elevated space-y-4">
                        ...
                        <button type="button" id="add-order-bump" class="w-full bg-dark-card text-gray-300 font-semibold py-2 px-4 rounded-lg hover:bg-[#32e768] hover:text-white transition duration-300 flex items-center justify-center gap-2 border border-dark-border">
                ...
                <div>
                    ...
                    <div class="p-4 border border-dark-border rounded-lg bg-dark-elevated space-y-4">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="text-sm">
                                <label for="enable_cpf" class="font-bold text-white text-base">Exibir campo CPF</label>
                                <p class="text-gray-400">Ativa ou desativa a exibição do campo de CPF no checkout.</p>
                            </div>
                        </div>
                         <div class="flex items-start space-x-4">
                            ...
                            <div class="text-sm">
                                <label for="enable_phone" class="font-bold text-white text-base">Exibir campo Telefone</label>
                                 <p class="text-gray-400">Ativa ou desativa a exibição do campo de Telefone no checkout.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h2 class="text-xl font-semibold mb-4 text-white flex items-center gap-2">
                        <i data-lucide="activity" class="w-5 h-5 text-[#32e768]"></i>
                        Rastreamento & Pixels
                    </h2>
                    <div class="space-y-4 p-4 border border-dark-border rounded-lg bg-dark-elevated">
                        <div>
            ...
            <div class="mt-8 border-t border-dark-border pt-6">
                <button type="submit" name="salvar_checkout" class="w-full bg-[#32e768] text-white font-bold py-3 px-8 rounded-lg hover:bg-[#28d15e] transition duration-300 flex items-center justify-center gap-2 shadow-lg shadow-[#32e768]/20">
    ...
    <div class="w-2/3 h-full p-8 bg-dark-elevated flex items-center justify-center">
        <div class="w-full max-w-2xl h-[90%] bg-dark-card rounded-2xl shadow-2xl overflow-hidden border border-[#32e768]">
...
<style>
    .form-checkbox { @apply focus:ring-[#32e768] h-6 w-6 text-[#32e768] border-dark-border rounded bg-dark-card; }
    .form-input-sm { 
        @apply w-full px-4 py-2 bg-dark-card border border-dark-border rounded-lg text-sm text-white placeholder-gray-500 focus:ring-[#32e768] focus:border-[#32e768]; 
