 ...
 */
if (file_exists(__DIR__ . '/../plugins/saas/includes/user_dashboard_info.php')) {
...
if (function_exists('plugin_active') && plugin_active('saas') && function_exists('get_user_plan_dashboard_info')) {
