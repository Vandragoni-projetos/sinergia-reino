...
<!-- Hero Section -->
<div class="bg-gradient-to-br from-[#32e768]/20 via-[#28d15e]/10 to-transparent p-8 rounded-lg shadow-lg mb-8 border border-[#32e768]/30">
    <div class="flex items-center gap-4 mb-4">
        <div class="w-16 h-16 rounded-full bg-[#32e768]/20 flex items-center justify-center">
            <i data-lucide="trending-up" class="w-8 h-8 text-[#32e768]"></i>
        </div>
        <div>
...
<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-dark-card p-6 rounded-lg shadow-md border border-dark-border hover:border-[#32e768]/50 transition-all duration-300">
        <div class="w-12 h-12 rounded-lg bg-[#32e768]/20 flex items-center justify-center mb-4">
            <i data-lucide="dollar-sign" class="w-6 h-6 text-[#32e768]"></i>
        </div>
    ...
    <div class="bg-dark-card p-6 rounded-lg shadow-md border border-dark-border hover:border-[#32e768]/50 transition-all duration-300">
        <div class="w-12 h-12 rounded-lg bg-[#32e768]/20 flex items-center justify-center mb-4">
            <i data-lucide="code" class="w-6 h-6 text-[#32e768]"></i>
        </div>
    ...
    <div class="bg-dark-card p-6 rounded-lg shadow-md border border-dark-border hover:border-[#32e768]/50 transition-all duration-300">
        <div class="w-12 h-12 rounded-lg bg-[#32e768]/20 flex items-center justify-center mb-4">
            <i data-lucide="headphones" class="w-6 h-6 text-[#32e768]"></i>
        </div>
    ...
    <div class="bg-dark-card p-6 rounded-lg shadow-md border border-dark-border hover:border-[#32e768]/50 transition-all duration-300">
        <div class="w-12 h-12 rounded-lg bg-[#32e768]/20 flex items-center justify-center mb-4">
            <i data-lucide="rocket" class="w-6 h-6 text-[#32e768]"></i>
        </div>
    ...
    <div class="bg-dark-card p-6 rounded-lg shadow-md border border-dark-border hover:border-[#32e768]/50 transition-all duration-300">
        <div class="w-12 h-12 rounded-lg bg-[#32e768]/20 flex items-center justify-center mb-4">
            <i data-lucide="zap" class="w-6 h-6 text-[#32e768]"></i>
        </div>
    ...
    <div class="bg-dark-card p-6 rounded-lg shadow-md border border-dark-border hover:border-[#32e768]/50 transition-all duration-300">
        <div class="w-12 h-12 rounded-lg bg-[#32e768]/20 flex items-center justify-center mb-4">
            <i data-lucide="trending-up" class="w-6 h-6 text-[#32e768]"></i>
        </div>
...
<div class="bg-dark-card p-8 rounded-lg shadow-md mb-8 border border-dark-border">
    <h2 class="text-2xl font-semibold mb-6 text-white flex items-center gap-2">
        <i data-lucide="info" class="w-6 h-6 text-[#32e768]"></i>
        <span>Como Funciona o Programa</span>
    </h2>
    
    <div class="space-y-6">
        <div class="flex gap-4">
            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-[#32e768]/20 flex items-center justify-center">
                <span class="text-[#32e768] font-bold">1</span>
            </div>
            <div>
        ...
        <div class="flex gap-4">
            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-[#32e768]/20 flex items-center justify-center">
                <span class="text-[#32e768] font-bold">2</span>
            </div>
            <div>
        ...
        <div class="flex gap-4">
            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-[#32e768]/20 flex items-center justify-center">
                <span class="text-[#32e768] font-bold">3</span>
            </div>
            <div>
        ...
        <div class="flex gap-4">
            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-[#32e768]/20 flex items-center justify-center">
                <span class="text-[#32e768] font-bold">4</span>
            </div>
            <div>
...
<!-- Seção de Promessa -->
<div class="bg-gradient-to-r from-[#32e768]/10 to-transparent p-8 rounded-lg shadow-md mb-8 border-l-4 border-[#32e768]">
    <div class="flex items-start gap-4">
        <i data-lucide="target" class="w-8 h-8 text-[#32e768] flex-shrink-0 mt-1"></i>
        <div>
            ...
            <ul class="space-y-3 text-gray-300">
                <li class="flex items-start gap-2">
                    <i data-lucide="check-circle" class="w-5 h-5 text-[#32e768] flex-shrink-0 mt-0.5"></i>
...
<!-- CTA Final -->
<div class="bg-dark-card p-8 rounded-lg shadow-lg border-2 border-[#32e768] text-center">
    <div class="max-w-2xl mx-auto">
        <div class="w-20 h-20 rounded-full bg-[#32e768]/20 flex items-center justify-center mx-auto mb-6">
            <i data-lucide="sparkles" class="w-10 h-10 text-[#32e768]"></i>
        </div>
