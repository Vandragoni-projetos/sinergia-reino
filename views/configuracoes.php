...
<head>
    ...
    <style>
        ...
        .selected-ring { 
            ring-width: 2px; 
            ring-color: #32e768; /* Green accent */
            background-color: rgba(50, 231, 104, 0.1); /* Green 10% */
            border-color: #32e768;
        }
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-300 leading-relaxed">
                        ...
                        <a href="/index?pagina=integracoes" class="text-[#32e768] hover:text-[#28d15e] font-semibold underline ml-1">Clique aqui para acessar</a>.
                    </p>
                </div>
            </div>
        </div>
