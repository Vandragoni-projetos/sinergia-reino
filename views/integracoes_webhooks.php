...
<div class="container mx-auto">
    <div class="flex items-center mb-6">
        ...
        <div>
            ...
            <p class="text-gray-400">Conecte a GatewayPro a outras plataformas.</p>
        </div>
    </div>
    ...
    <div class="bg-dark-card p-8 rounded-lg shadow-md mb-8 border border-[#32e768]">
        ...
        <form id="webhook-form" class="space-y-6">
            ...
            <div class="flex items-center justify-end space-x-4 mt-6">
                ...
                <button type="submit" id="save-webhook-btn" class="bg-[#32e768] text-white font-bold py-2 px-5 rounded-lg hover:bg-[#28d15e] transition duration-300 flex items-center space-x-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchWebhooks() {
        showLoading();
        try {
            const response = await fetch('/api/api?action=get_webhooks');
    ...
    async function deleteWebhook(webhookId) {
        ...
        try {
            const response = await fetch('/api/api?action=delete_webhook', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    async function testWebhook(url) {
        ...
        try {
            const response = await fetch('/api/api?action=test_webhook', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
